...
//pulled from https://github.com/Meirshomron/EventManagers

//looks like there's not too many ways to write event managers, I like the idea of a generic object you can pass along with the event
...
public class EventManager : MonoBehaviour
{
    ...
    public static void TriggerEvent(string eventName, ActionParams actionParams)
    {
        if (Instance.eventDictionary.TryGetValue(eventName, out var actions))
        {
